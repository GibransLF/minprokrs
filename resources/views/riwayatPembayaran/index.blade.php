        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 justify-center">
                    ...
                    <form class="max-w-lg mx-auto" action="{{route('dashboard')}}" method="get">
                        <div class="flex">
                            ...
                            <div class="relative w-full">
                                <input type="search" name="nama" id="search-dropdown"
                                    class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                                    placeholder="Cari Nama Pemesan..." value="{{ request('nama') }}" />
                                <button type="submit"
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 justify-center">
                    ...
                    <a href="{{route('riwayatPembayaran.detail')}}" class="flex flex-col mb-4
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal w-full">
                            ...
                            <p class="text-gray-900 dark:text-gray-900 font-bold">0123210 - Nama Mahasiswa</p>
