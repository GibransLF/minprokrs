                    ...
                    <table id="search-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button data-modal-target="edit-modal{{$fakultas->id}}"
                                        data-modal-toggle="edit-modal{{$fakultas->id}}" type="button"
                                    ...
                                    &nbsp;
                                    <button data-modal-target="delete-modal{{$fakultas->id}}"
                                        data-modal-toggle="delete-modal{{$fakultas->id}}" type="button"
