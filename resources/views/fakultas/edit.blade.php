<!-- Main modal -->
<div id="edit-modal{{$fakultas->id}}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="edit-modal{{$fakultas->id}}">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{route('fakultas.update', $fakultas->id)}}" method="POST">
                @CSRF
                @method('PATCH')
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="kode_fakultas"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Fakultas</label>
                        <input type="text" name="kode_fakultas" id="kode_fakultas" value="{{$fakultas->kode_fakultas}}"
                            ...
                            placeholder="{{$fakultas->kode_fakultas}}}}" required="">
                    </div>
                    <div class="col-span-2">
                        <label for="nama_fakultas"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Fakultas</label>
                        <input type="text" name="nama_fakultas" id="nama_fakultas" value="{{$fakultas->nama_fakultas}}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="{{$fakultas->nama_fakultas}}" required="">
                    </div>
                </div>
                <button type="submit"
