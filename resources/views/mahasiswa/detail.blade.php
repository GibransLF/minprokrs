<!-- Main modal -->
<div id="detail-modal{{$mhs->id}}" tabindex="-1" aria-hidden="true"
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Type product name" required="" value="{{ $mhs->user->name }}" disabled>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="nim" id="nim"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Type product name" required="" value="{{ $mhs->nim }}" disabled>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label for="email"
                        ...
                        <input type="text" name="email" id="email"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Type product name" required="" value="{{ $mhs->user->email }}" disabled>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label for="category"
                        ...
                        <select id="category"
                            ...
                            required disabled>
                            <option selected="">{{ $mhs->Fakultas->nama_fakultas }}</option>
                        </select>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label for="category"
