<!-- Main modal -->
<div id="edit-modal{{$krs->id}}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="edit-modal{{$krs->id}}">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{route('jadwalPerkuliahan.update' , $semester->id)}}" method="POST">
                @csrf
                @method('PATCH')
                <div class="col-span-2">
                    <label for="mk_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih
                        Mata Kuliah</label>
                    <select id="mk_id" name="mk_id"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required>
                        <option value="{{$krs->mk_id}}" hidden>{{$krs->jurusan->nama_jurusan}} - {{
                            $krs->matkul->nama_mk}}</option>
                        @foreach ( $mataKuliah as $mk )
                        <option value="{{$mk->id}}">{{$mk->jurusan->nama_jurusan}} - {{ $mk->nama_mk}}</option>
                        @endforeach
                    </select>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="time" id="mulai"
                                        ...
                                        name="mulai" value="{{$krs->mulai}}" required />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="time" id="selesai"
                                        class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        name="selesai" value="{{$krs->selesai}}" required />
                                </div>
