...
<div id="add-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{route('dosen.store')}}" method="POST">
                @CSRF
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="nidn"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIDN</label>
                        <input type="number" inputmode="numeric" name="nidn" id="nidn" value="{{old('nidn')}}"
                            ...
                            placeholder="Ketikan Nomor Induk Dosen Nasional" required="">
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nama_dosen" id="nama_dosen" value="{{old('nama_dosen')}}"
                            ...
                            placeholder="Ketikan nama Dosen" required="">
                    </div>
                </div>
                <button type="submit"
