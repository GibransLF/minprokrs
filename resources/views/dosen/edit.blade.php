<!-- Main modal -->
<div id="edit-modal{{ $dosen->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="edit-modal{{ $dosen->id }}">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{route('dosen.update', $dosen->id)}}" method="POST">
                @CSRF
                @method('PATCH')
