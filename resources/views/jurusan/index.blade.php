                    ...
                    <table id="search-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button data-modal-target="edit-modal{{$jurusan->id}}" data-modal-toggle="edit-modal{{$jurusan->id}}" type="button" class="text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:focus:ring-yellow-900">
                                        Ubah
                                    </button>
                                    @include('jurusan.edit')
                                    &nbsp;
                                    <button data-modal-target="delete-modal{{$jurusan->id}}" data-modal-toggle="delete-modal{{$jurusan->id}}" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Hapus</button>
