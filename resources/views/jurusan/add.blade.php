            ...
            <form class="p-4 md:p-5" action="{{route('jurusan.store')}}" method="POST">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="kode_jurusan" id="kode_jurusan" value="{{old('kode_jurusan')}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Ketikan kode jurusan" required="">
                    </div>
                    <div class="col-span-2">
                        <label for="nama_jurusan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama jurusan</label>
                        <input type="text" name="nama_jurusan" id="nama_jurusan" value="{{old('nama_jurusan')}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Ketikan nama jurusan" required="">
                    </div>
                </div>
